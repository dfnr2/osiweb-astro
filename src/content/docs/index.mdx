...
with the help of the Netscape built-in editor.  In 2025, I rebuilt the site using
the astro static site generater.


## Recent News

**03-Sep-2025**: Migrated the old netscape-built site to a modern platform. [Legacy Site](/legacy.html)
