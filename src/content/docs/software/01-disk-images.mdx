...
| [Planner Plus v4.01 System](/disk_images/PlannerPlus_v4.01_System.65U)<br/>[Planner Plus v4.01 Sampler](/disk_images/PlannerPlus_v4.01_Sampler.65U) | OS-65U (C2/C3/C8) | 8" | OSI Planner Plus v4.01 — a spreadsheet modeling program. Mount the System image on drive/Dev A (it boots) and the Sampler image on drive/Dev B. Per lowrybt1: "the software allows users to define a grid with perhaps as many as 96x24 rows/columns (to be confirmed), apparently called 'items' instead of cells with the ultimate objective of engaging in descriptive or predictive financial and statistical modeling. The grid of items can be viewed, scrolled through and edited to some limited extent in Planner's 'immediate' mode. Some items are labels for rows and columns and the rest are populated with data or calculated results driven by formulas or 'Rules' which appears to be the preferred terminology in Planner." Includes config support for a range of terminals and C4P/C8P video systems. Recovered and contributed by lowrybt1. |
